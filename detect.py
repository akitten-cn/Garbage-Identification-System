...
def run(
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if save_img:
                if dataset.mode == "image":
                    cv2.imwrite(save_path, im0)                 ##检测图像保存函数
    ...
    return save_dir,new_cls,new_number
...
def parse_opt():
    ...
    parser.add_argument("--source", type=str, default=ROOT / "垃圾测试数据", help="file/dir/URL/glob/screen/0(webcam)")
